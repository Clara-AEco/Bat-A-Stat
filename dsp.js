...
(function (ns) {
  ...
  function computeSpectrogram(samples, sampleRate, fftSize, hopSize) {
    ...
    return { numFrames, numBins, magDb, frameTimes, freqs, sampleRate, fftSize, hopSize, durationSec: samples.length / sampleRate };
  }
